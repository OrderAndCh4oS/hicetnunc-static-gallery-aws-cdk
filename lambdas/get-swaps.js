...
const CONSEIL_API_URL = process.env.CONSEIL_API_URL
const CONSEIL_API_KEY = process.env.CONSEIL_API_KEY
...
registerFetch(fetch);
const conseilServer = CONSEIL_API_URL;
const conseilApiKey = CONSEIL_API_KEY; // signup at nautilus.cloud
const mainnet = {
    network: 'mainnet',
